/**
 * DevPayr Injectables Receiver (Vanilla Node.js, ESM)
 */
...
const PORT = 3001;
const LOG_FILE = path.join(__dirname, 'devpayr_injectables_js.log');
...
server.listen(PORT, () => {
    console.log(`[DevPayr SDK] Injectables receiver running on http://localhost:${PORT}`);
});
